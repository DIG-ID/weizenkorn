 ...
 *
 * preview-cards ("Entdecken Sie mehr") closes the page — a real post context, so
 * unprefixed like every other page/single use of it; see the module's own docblock for the
 * two ACF Clone fields it expects.
 *
 * @package weizenkorn
 * @subpackage Template
 * @since 1.10.0
