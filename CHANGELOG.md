...
- Quote slider: every slide now matches the height of the tallest one on mobile and tablet too, so swiping between a short quote and a long one no longer resizes the slider.
