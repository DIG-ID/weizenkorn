...
- Mega menu: on a wide (2K/4K) screen the photo no longer stretches tall — the menu's own width now grows to 2560px on those screens instead of stopping at the site's usual 1920px, and its rows no longer grow past the height the menu links actually need.
