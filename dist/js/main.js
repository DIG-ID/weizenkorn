...
/* harmony export */   initAnchorScroll: () => (/* binding */ initAnchorScroll)
/* harmony export */ });
...
function initAnchorScroll() {
  ...
  if (window.location.hash) {
    ...
    if (target) {
      window.scrollTo(0, 0);
      _gsap_js__WEBPACK_IMPORTED_MODULE_0__.lenis.scrollTo(target, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCardProgram: () => (/* binding */ initCardProgram)
/* harmony export */ });
/**
 ...
 */
function initCardProgram() {
  document.querySelectorAll('.js-card-program-toggle').forEach(function (button) {
    button.addEventListener('click', function () {
      var card = button.closest('.js-card-program');
      if (!card) {
        return;
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initFilterPanel: () => (/* binding */ initFilterPanel)
/* harmony export */ });
/**
...
function initFilterPanel() {
  ...
  var trigger = document.querySelector('.js-filter-panel-trigger');
  if (!panel || !trigger) {
    return null;
  }
  var closeBtn = document.querySelector('.js-filter-panel-close');
  var backdrop = document.querySelector('.js-filter-panel-backdrop');
  var badge = document.querySelector('.js-filter-panel-badge');
  var applyBtn = document.querySelector('.js-filter-panel-apply');
  var clearBtn = document.querySelector('.js-filter-panel-clear');
  var inputs = function inputs() {
    return Array.prototype.slice.call(panel.querySelectorAll('.filter-panel__input'));
  };
  ...
  var open = function open() {
    ...
    if (backdrop) {
      ...
      requestAnimationFrame(function () {
        return backdrop.classList.add('is-visible');
      });
    }
  ...
  var updateBadge = function updateBadge(count) {
    if (!badge) {
      return;
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initHeroFit: () => (/* binding */ initHeroFit)
/* harmony export */ });
/**
...
var BOTTOM_GAP_PX = 48;
var RESIZE_DEBOUNCE_MS = 150;
function initHeroFit() {
  var content = document.querySelector('.section-hero__content');
  if (!content) {
    return;
  }
  var media = document.querySelector('.section-hero__media');
  var targets = [{
    el: content.querySelector('.section-hero__title'),
    prop: 'marginBottom',
    floor: 24
  }, {
    el: content,
    ...
    el: content.querySelector('.section-hero__body'),
    prop: 'marginBottom',
    floor: 16
  }, {
    el: content.querySelector('.section-hero__tagline'),
    prop: 'marginBottom',
    floor: 4
  ...
  var fit = function fit() {
    ...
    // up, never fights it.
    reset();
    var targetHeight = window.innerHeight - getHeaderHeight() - BOTTOM_GAP_PX;
    var overflow = content.scrollHeight - targetHeight;
    if (overflow > 0) {
      targets.forEach(function (_ref2) {
        ...
        var current = parseFloat(getComputedStyle(el)[prop]) || 0;
        var reduceBy = Math.min(Math.max(0, current - floor), overflow);
        if (reduceBy > 0) {
          el.style[prop] = "".concat(current - reduceBy, "px");
          overflow -= reduceBy;
        }
      });
    ...
    if (media) {
      var finalHeight = Math.max(targetHeight, content.offsetHeight);
      media.style.maxHeight = 'none';
      media.style.height = "".concat(finalHeight, "px");
    }
  };
  var resizeTimer;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initJobFilters: () => (/* binding */ initJobFilters)
/* harmony export */ });
/* harmony import */ var _filter_panel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter-panel.js */ "./assets/js/filter-panel.js");
...
function initJobFilters() {
  var grid = document.querySelector('.js-job-listing-grid');
  if (!grid || !window.weizenkornJobs || !window.weizenkornJobs.restUrl) {
    return;
  }
  var filterPanel = (0,_filter_panel_js__WEBPACK_IMPORTED_MODULE_0__.initFilterPanel)();
  if (!filterPanel) {
    return;
  }
  var _window$weizenkornJob = window.weizenkornJobs,
    restUrl = _window$weizenkornJob.restUrl,
    resultSingular = _window$weizenkornJob.resultSingular,
    resultPlural = _window$weizenkornJob.resultPlural;
  var inputs = filterPanel.inputs,
    applyBtn = filterPanel.applyBtn,
    clearBtn = filterPanel.clearBtn,
    close = filterPanel.close,
    updateBadge = filterPanel.updateBadge;
  var countText = document.querySelector('.js-job-listing-count');
  var moreWrap = document.querySelector('.js-job-listing-more');
  var moreBtn = moreWrap ? moreWrap.querySelector('.btn') : null;
  var committed = {
    anstellungsart: [],
    standort: []
  };
  ...
  var totalSelected = function totalSelected(selected) {
    return Object.keys(selected).reduce(function (total, key) {
      return total + selected[key].length;
    }, 0);
  };
  var buildUrl = function buildUrl(filters, page) {
    var params = new URLSearchParams();
    filters.anstellungsart.forEach(function (value) {
      return params.append('anstellungsart[]', value);
    });
    filters.standort.forEach(function (value) {
      return params.append('standort[]', value);
    });
    params.set('page', String(page));
    return "".concat(restUrl, "?").concat(params.toString());
  };
  var load = function load(filters, page, append) {
    grid.classList.add('is-loading');
    fetch(buildUrl(filters, page)).then(function (response) {
      ...
      if (countText) {
        countText.textContent = "".concat(data.found, " ").concat(data.found === 1 ? resultSingular : resultPlural);
      }
    })["finally"](function () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initLanguageSwitcher: () => (/* binding */ initLanguageSwitcher)
/* harmony export */ });
/* harmony import */ var _gsap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gsap.js */ "./assets/js/gsap.js");
/**
...
function initLanguageSwitcher() {
  var wrappers = document.querySelectorAll('.header-main__lang');
  wrappers.forEach(function (wrapper) {
    var list = wrapper.querySelector('.wpml-ls-legacy-list-horizontal');
    var currentLabel = wrapper.querySelector('.wpml-ls-current-language .wpml-ls-native');
    ...
    var dropdownTl = _gsap_js__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
      paused: true
    }).set(list, {
      display: 'block'
    }).to(list, {
    ...
    dropdownTl.eventCallback('onReverseComplete', function () {
      _gsap_js__WEBPACK_IMPORTED_MODULE_0__.gsap.set(list, {
        display: 'none'
      });
    });
    ...
    var applyResponsiveState = function applyResponsiveState() {
      var shouldBeMobile = window.innerWidth < MOBILE_BREAKPOINT;
      ...
      if (shouldBeMobile) {
        ...
        closeDropdown();
        _gsap_js__WEBPACK_IMPORTED_MODULE_0__.gsap.set(list, {
          clearProps: 'display,clipPath,opacity,visibility'
        });
      }
    };
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gsap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gsap.js */ "./assets/js/gsap.js");
/* harmony import */ var _swiper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swiper.js */ "./assets/js/swiper.js");
/* harmony import */ var _utils_helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/helpers.js */ "./assets/js/utils/helpers.js");
/* harmony import */ var _sticky_header_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sticky-header.js */ "./assets/js/sticky-header.js");
/* harmony import */ var _menu_overlay_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./menu-overlay.js */ "./assets/js/menu-overlay.js");
/* harmony import */ var _language_switcher_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./language-switcher.js */ "./assets/js/language-switcher.js");
/* harmony import */ var _sticky_cta_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sticky-cta.js */ "./assets/js/sticky-cta.js");
/* harmony import */ var _hero_fit_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./hero-fit.js */ "./assets/js/hero-fit.js");
/* harmony import */ var _process_steps_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./process-steps.js */ "./assets/js/process-steps.js");
/* harmony import */ var _job_filters_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./job-filters.js */ "./assets/js/job-filters.js");
/* harmony import */ var _team_filters_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./team-filters.js */ "./assets/js/team-filters.js");
/* harmony import */ var _news_pagination_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./news-pagination.js */ "./assets/js/news-pagination.js");
/* harmony import */ var _video_facade_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./video-facade.js */ "./assets/js/video-facade.js");
/* harmony import */ var _preview_cards_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./preview-cards.js */ "./assets/js/preview-cards.js");
/* harmony import */ var _card_program_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./card-program.js */ "./assets/js/card-program.js");
/* harmony import */ var _reveal_cards_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./reveal-cards.js */ "./assets/js/reveal-cards.js");
/* harmony import */ var _anchor_scroll_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./anchor-scroll.js */ "./assets/js/anchor-scroll.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_job_filters_js__WEBPACK_IMPORTED_MODULE_9__.initJobFilters)();
  (0,_team_filters_js__WEBPACK_IMPORTED_MODULE_10__.initTeamFilters)();
  (0,_sticky_header_js__WEBPACK_IMPORTED_MODULE_3__.initStickyHeader)();
  (0,_menu_overlay_js__WEBPACK_IMPORTED_MODULE_4__.initMenuOverlay)();
  (0,_language_switcher_js__WEBPACK_IMPORTED_MODULE_5__.initLanguageSwitcher)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initGastronomySlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initQuoteSlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initStoriesSlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initServicesSlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initEquipmentSlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initDiversitySlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initDiversityCardsSlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initRelatedJobsSlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initNewsSlider)();
  (0,_swiper_js__WEBPACK_IMPORTED_MODULE_1__.initDonationProjectsSlider)();
  (0,_sticky_cta_js__WEBPACK_IMPORTED_MODULE_6__.initStickyCta)();
  (0,_hero_fit_js__WEBPACK_IMPORTED_MODULE_7__.initHeroFit)();
  (0,_process_steps_js__WEBPACK_IMPORTED_MODULE_8__.initProcessSteps)();
  (0,_news_pagination_js__WEBPACK_IMPORTED_MODULE_11__.initNewsPagination)();
  (0,_video_facade_js__WEBPACK_IMPORTED_MODULE_12__.initVideoFacade)();
  (0,_preview_cards_js__WEBPACK_IMPORTED_MODULE_13__.initPreviewCards)();
  (0,_card_program_js__WEBPACK_IMPORTED_MODULE_14__.initCardProgram)();
  (0,_reveal_cards_js__WEBPACK_IMPORTED_MODULE_15__.initRevealCards)();
  (0,_anchor_scroll_js__WEBPACK_IMPORTED_MODULE_16__.initAnchorScroll)();
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initMenuOverlay: () => (/* binding */ initMenuOverlay)
/* harmony export */ });
/* harmony import */ var _gsap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gsap.js */ "./assets/js/gsap.js");
/**
...
var SWAP_SUPERSEDED = {};
var MOBILE_BREAKPOINT = 768;
var ARROW_ICON = '<svg width="24" height="19" viewBox="0 0 23.7301 18.632" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M0 9.31602H22M10 17.816L22 9.31602L10 0.816024" stroke="currentColor" stroke-width="2" /></svg>';
...
function initMobileMenuAccordion(overlay) {
  var groups = overlay.querySelectorAll('.menu-overlay__col > ul > li');
  var overviewLabel = overlay.dataset.overviewLabel || 'Übersicht';
  groups.forEach(function (group, index) {
    var link = group.querySelector(':scope > a');
    var subMenu = group.querySelector(':scope > .sub-menu');
    if (!link || !subMenu) {
      return;
    }
    ...
    var subMenuId = subMenu.id || "menu-overlay-submenu-".concat(index);
    ...
    link.addEventListener('click', function (e) {
      ...
      subMenu.style.maxHeight = isOpen ? '0px' : "".concat(subMenu.scrollHeight, "px");
    });
  });
  ...
  window.addEventListener('resize', function () {
    ...
    overlay.querySelectorAll('.menu-overlay__group--accordion > .sub-menu').forEach(function (subMenu) {
...
function initMenuOverlay() {
  var toggles = document.querySelectorAll('.header-main__menu-toggle');
  var overlay = document.getElementById('menu-overlay');
  if (!toggles.length || !overlay) {
    return;
  }
  var image = overlay.querySelector('.menu-overlay__image-el');
  var imageContainer = overlay.querySelector('.menu-overlay__image');
  var grid = overlay.querySelector('.menu-overlay__grid');
  var header = document.querySelector('.header-main');
  var defaultSrc = image ? image.dataset.defaultSrc : '';
  ...
  var syncHeaderHeight = function syncHeaderHeight() {
    if (!header) {
      return;
    }
  ...
  var syncImageHeight = function syncImageHeight() {
    if (!grid || !imageContainer) {
      return;
    }
    imageContainer.style.maxHeight = "".concat(grid.clientHeight, "px");
  };
  syncImageHeight();
  ...
  var preload = function preload(src) {
    if (!preloads.has(src)) {
      preloads.set(src, new Promise(function (resolve) {
  ...
  var setImage = function setImage(src) {
    ...
    var abortIfSuperseded = function abortIfSuperseded() {
      if (token !== swapToken) {
    ...
    preload(src).then(abortIfSuperseded).then(function () {
      image.classList.add('is-fading');
      return wait(IMAGE_FADE_MS);
    }).then(abortIfSuperseded).then(function () {
      image.src = src;
  ...
  var preloadMenuImages = function preloadMenuImages() {
    overlay.querySelectorAll('[data-menu-image]').forEach(function (link) {
  ...
  overlay.addEventListener('mouseover', function (e) {
    var link = e.target.closest('[data-menu-image]');
    if (link) {
  ...
  var setExpanded = function setExpanded(expanded) {
    toggles.forEach(function (toggle) {
      return toggle.setAttribute('aria-expanded', String(expanded));
    });
  };
  ...
  var revealTargets = overlay.querySelectorAll('.menu-overlay__col > ul > li, .menu-overlay__image');
  _gsap_js__WEBPACK_IMPORTED_MODULE_0__.gsap.set(revealTargets, {
    autoAlpha: 0,
    y: -16
  });
  var revealTl = _gsap_js__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    paused: true
  }).to(overlay, {
    clipPath: 'inset(0% 0% 0% 0%)',
    duration: 0.6,
  ...
  var isMenuOpen = function isMenuOpen() {
    return toggles.length > 0 && toggles[0].getAttribute('aria-expanded') === 'true';
  };
  toggles.forEach(function (toggle) {
    toggle.addEventListener('click', function () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initNewsPagination: () => (/* binding */ initNewsPagination)
/* harmony export */ });
...
function initNewsPagination() {
  ...
  var endpoint = grid.dataset.endpoint || '/wp-json/weizenkorn/v1/news';
  ...
  var SLIDE = 300;
  var slideMs = function slideMs() {
    return still.matches ? 0 : SLIDE;
  };
  var setArrows = function setArrows(page, max) {
    [[prev, page > 1, page - 1], [next, page < max, page + 1]].forEach(function (_ref) {
      ...
      var url = new URL(arrow.href, window.location.origin);
  ...
  var go = function go(page, dir) {
    var max = parseInt(grid.dataset.max, 10) || 1;
    ...
    var faded = new Promise(function (resolve) {
      window.setTimeout(resolve, slideMs());
    });
    var asked = fetch(url.toString(), {
      headers: {
    ...
    Promise.all([asked, faded]).then(function (_ref3) {
  ...
  var bind = function bind(arrow, step) {
    if (!arrow) {
      return;
    }
  ...
  window.addEventListener('popstate', function () {
    var page = parseInt(new URL(window.location.href).searchParams.get('news_page'), 10) || 1;
    var current = parseInt(grid.dataset.page, 10) || 1;
    if (page !== current) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initPreviewCards: () => (/* binding */ initPreviewCards)
/* harmony export */ });
/**
...
function initPreviewCards() {
  document.querySelectorAll('.js-card-preview-toggle').forEach(function (button) {
    button.addEventListener('click', function () {
      var card = button.closest('.js-card-preview');
      if (!card) {
        return;
      }
      var isOpen = card.classList.toggle('is-open');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProcessSteps: () => (/* binding */ initProcessSteps)
/* harmony export */ });
/**
...
function initProcessSteps() {
  var items = document.querySelectorAll('.process-steps__item');
  if (!items.length) {
    return;
  }
  var steps = [];
  items.forEach(function (item) {
    var button = item.querySelector('.process-steps__toggle');
    var text = button ? document.getElementById(button.getAttribute('aria-controls')) : null;
    if (!button || !text) {
      return;
    }
    steps.push({
  ...
  var setOpen = function setOpen(step, open) {
    step.button.setAttribute('aria-expanded', open ? 'true' : 'false');
    step.text.classList.toggle('is-open', open);
  };
  steps.forEach(function (step) {
    step.item.addEventListener('click', function () {
      var open = !step.text.classList.contains('is-open');
...
/* harmony export */   initRevealCards: () => (/* binding */ initRevealCards)
/* harmony export */ });
/**
...
function isTapMode(card, selectors) {
  var toggle = card.querySelector(selectors.toggle);
...
function bindCard(card, selectors) {
  ...
  var state = card.querySelector(selectors.toggleButton) || card;
...
function initRevealCards() {
  CARDS.forEach(function (selectors) {
    document.querySelectorAll(selectors.card).forEach(function (card) {
      return bindCard(card, selectors);
    });
  });
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initRevealCards);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initStickyCta: () => (/* binding */ initStickyCta)
/* harmony export */ });
/**
...
function initStickyCta() {
  ...
  var startsCollapsed = window.matchMedia(MOBILE_QUERY).matches;
  if (startsCollapsed) {
    el.classList.add('is-collapsed');
  }
  var collapseTimer = startsCollapsed ? null : setTimeout(function () {
    return el.classList.add('is-collapsed');
  }, COLLAPSE_DELAY_MS);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initStickyHeader: () => (/* binding */ initStickyHeader)
/* harmony export */ });
/**
...
function initStickyHeader() {
  ...
  new MutationObserver(toggleSticky).observe(document.body, {
    attributes: true,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initDiversityCardsSlider: () => (/* binding */ initDiversityCardsSlider),
/* harmony export */   initDiversitySlider: () => (/* binding */ initDiversitySlider),
/* harmony export */   initDonationProjectsSlider: () => (/* binding */ initDonationProjectsSlider),
/* harmony export */   initEquipmentSlider: () => (/* binding */ initEquipmentSlider),
/* harmony export */   initGastronomySlider: () => (/* binding */ initGastronomySlider),
/* harmony export */   initNewsSlider: () => (/* binding */ initNewsSlider),
/* harmony export */   initQuoteSlider: () => (/* binding */ initQuoteSlider),
/* harmony export */   initRelatedJobsSlider: () => (/* binding */ initRelatedJobsSlider),
/* harmony export */   initServicesSlider: () => (/* binding */ initServicesSlider),
/* harmony export */   initStoriesSlider: () => (/* binding */ initStoriesSlider)
/* harmony export */ });
 ...
 */
function initGastronomySlider() {
  document.querySelectorAll('.js-gastronomy-slider').forEach(function (el) {
...
function initServicesSlider() {
  document.querySelectorAll('.js-services-slider').forEach(function (el) {
    var root = el.closest('.section-services');
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.A11y, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],
      autoplay: {
        delay: 5000
      },
      spaceBetween: 20,
...
function initStoriesSlider() {
  document.querySelectorAll('.js-stories-slider').forEach(function (el) {
    var root = el.closest('.stories-references');
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.A11y],
...
function initNewsSlider() {
  document.querySelectorAll('.js-news-slider').forEach(function (el) {
    var root = el.closest('.news-cards');
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.A11y],
      // The grid's own gutter.
      spaceBetween: 20,
...
function equalizeQuoteBoxHeights(root) {
  var boxes = root ? Array.from(root.querySelectorAll('.quote-slider__box')) : [];
  if (!boxes.length) {
    return;
  }
  ...
  var tallest = Math.max.apply(Math, _toConsumableArray(boxes.map(function (box) {
    return box.offsetHeight;
  })));
  boxes.forEach(function (box) {
    box.style.height = "".concat(tallest, "px");
  });
}
...
function initQuoteSlider() {
  document.querySelectorAll('.js-quote-slider').forEach(function (el) {
    var root = el.closest('.quote-slider');
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      ...
      on: {
        init: function init() {
          return equalizeQuoteBoxHeights(root);
        }
      }
    });
    window.addEventListener('resize', (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_2__.debounce)(function () {
      return equalizeQuoteBoxHeights(root);
    }), {
      passive: true
    });
...
function initEquipmentSlider() {
  document.querySelectorAll('.js-equipment-slider').forEach(function (el) {
    var root = el.closest('.our-equipment');
    var paginationEl = root ? root.querySelector('.js-equipment-pagination') : null;
    ...
    // element and root.
    var centerActiveBullet = function centerActiveBullet() {
      if (!paginationEl || !window.matchMedia('(max-width: 767px)').matches) {
        return;
      }
      var activeBullet = paginationEl.querySelector('.swiper-pagination-bullet-active');
      if (activeBullet) {
        ...
        var bulletRect = activeBullet.getBoundingClientRect();
        var rowRect = paginationEl.getBoundingClientRect();
 ...
 * never shows any.
 */
function initDiversitySlider() {
  document.querySelectorAll('.js-diversity-slider').forEach(function (el) {
    var root = el.closest('.section-diversity-slider');
    var paginationEl = root ? root.querySelector('.js-diversity-pagination') : null;
 ...
 */
function initDiversityCardsSlider() {
  document.querySelectorAll('.js-diversity-cards-slider').forEach(function (el) {
    var root = el.closest('.section-diversity-cards');
    var paginationEl = root ? root.querySelector('.js-diversity-cards-pagination') : null;
 ...
 */
function initRelatedJobsSlider() {
  document.querySelectorAll('.js-related-jobs-slider').forEach(function (el) {
    var root = el.closest('.related-jobs');
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.A11y],
      spaceBetween: 20,
      slidesPerView: 1,
 ...
 */
function initDonationProjectsSlider() {
  document.querySelectorAll('.js-donation-projects-slider').forEach(function (el) {
    var root = el.closest('.donation-projects');
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.A11y],
      spaceBetween: 20,
      slidesPerView: 1,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initTeamFilters: () => (/* binding */ initTeamFilters)
/* harmony export */ });
/* harmony import */ var _filter_panel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter-panel.js */ "./assets/js/filter-panel.js");
...
function initTeamFilters() {
  var grid = document.querySelector('.js-team-grid');
  ...
  var _window$weizenkornTea = window.weizenkornTeam,
    resultSingular = _window$weizenkornTea.resultSingular,
    resultPlural = _window$weizenkornTea.resultPlural;
  var inputs = filterPanel.inputs,
    applyBtn = filterPanel.applyBtn,
    clearBtn = filterPanel.clearBtn,
    close = filterPanel.close,
  ...
  var countText = document.querySelector('.js-team-count');
  var moreWrap = document.querySelector('.js-team-more');
  var moreBtn = moreWrap ? moreWrap.querySelector('.btn') : null;
  var matches = cards.slice();
  var revealed = PER_PAGE;
  var render = function render() {
    ...
    if (countText) {
      countText.textContent = "".concat(matches.length, " ").concat(matches.length === 1 ? resultSingular : resultPlural);
    }
    if (moreWrap) {
  ...
  var applyFilters = function applyFilters(selected) {
    matches = cards.filter(function (card) {
      var bereichOk = !selected.bereich.length || selected.bereich.includes(card.dataset.bereich);
      var standortOk = !selected.standort.length || selected.standort.includes(card.dataset.standort);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   initVideoFacade: () => (/* binding */ initVideoFacade)
/* harmony export */ });
/**
...
var SELECTOR = '[data-video-facade]';
...
function activate(facade) {
  var src = facade.dataset.videoFacade;
  if (!src) {
    return;
  }
...
function initVideoFacade() {
  var facades = document.querySelectorAll(SELECTOR);
  if (!facades.length) {
    return;
  }
  facades.forEach(function (facade) {
    facade.addEventListener('click', function () {
      return activate(facade);
    });
  });
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initVideoFacade);
...
/***/ "./assets/sass/admin-dashboard.sass"
/*!******************************************!*\
  !*** ./assets/sass/admin-dashboard.sass ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkweizenkorn"] = self["webpackChunkweizenkorn"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/main","css/editor","css/admin-bar","css/admin-dashboard","css/admin-login"], () => (__webpack_require__("./assets/js/main.js")))
/******/ 	__webpack_require__.O(undefined, ["css/main","css/editor","css/admin-bar","css/admin-dashboard","css/admin-login"], () => (__webpack_require__("./assets/sass/main.sass")))
/******/ 	__webpack_require__.O(undefined, ["css/main","css/editor","css/admin-bar","css/admin-dashboard","css/admin-login"], () => (__webpack_require__("./assets/sass/admin-login.sass")))
/******/ 	__webpack_require__.O(undefined, ["css/main","css/editor","css/admin-bar","css/admin-dashboard","css/admin-login"], () => (__webpack_require__("./assets/sass/admin-dashboard.sass")))
/******/ 	__webpack_require__.O(undefined, ["css/main","css/editor","css/admin-bar","css/admin-dashboard","css/admin-login"], () => (__webpack_require__("./assets/sass/admin-bar.sass")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/main","css/editor","css/admin-bar","css/admin-dashboard","css/admin-login"], () => (__webpack_require__("./assets/sass/editor.sass")))
