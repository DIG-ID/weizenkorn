 ...
 * bento, the shared category-grid module ("Schaffen Perspektiven" — moved
 * here from the Open Positions archive, which used to call it as "Schaffen
 * Perspektiven. Unsere Ausbildungen"; see that template's own docblock),
 * the shared numbered-steps module ("Der Weg zu einem Platz bei Weizenkorn
 * in 4 Schritten"), the shared quote-slider and the shared faq module
 * (both commented out below — TEMP, launch), the shared contact-person
 * module ("Bereit für Weizenkorn?"), and the shared preview-cards module
 * ("Entdecken Sie mehr"), unprefixed like every other use of it — see the
 * module's own docblock for the two ACF Clone fields it expects. The
 * Figma frame's "Das könnte Sie auch interessieren" section is
