 ...
 * Ausbildungsstelle?"), the shared numbered-steps module ("Der Weg zu
 * einem Platz bei Weizenkorn in 4 Schritten"), the shared category-grid
 * module ("Schaffen Perspektiven" — moved here from the Open Positions
 * archive, which used to call it as "Schaffen Perspektiven. Unsere
 * Ausbildungen"; see that template's own docblock), this page's own
 * "Unsere Ausbildung" programme bento, the shared quote-slider and the
 * shared faq module (both commented out below — TEMP, launch), the shared
