<?php
/**
 * Template Name: Gastronomie - Rhyvage Template
 *
 * The Rhyvage page of the gastronomy venues. Each venue gets its own
 ...
 * every venue page passes), booking, location, preview-cards (unprefixed, like every other
 * use of it — see the module's own docblock for the two ACF Clone fields it expects).
 *
