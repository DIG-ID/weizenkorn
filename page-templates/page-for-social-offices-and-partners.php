 ...
 * intro-cta module ("Was uns wichtig ist", text-only — no button), the
 * shared offer-links module ("Angebote im Überblick"), this page's own
 * "Downloads & Unterlagen" document cards and "Wir sind für Sie da" team
 * grid, and a closing "Dürfen wir weiterhelfen?" contact + form section
