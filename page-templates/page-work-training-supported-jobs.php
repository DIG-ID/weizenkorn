 ...
 * category-grid module ("Sinnstiftend vielfältig Unsere Arbeitsstellen" —
 * moved here from the Open Positions archive, which used to call it under
 * that same name; see that template's own docblock), the shared
 * numbered-steps module ("Der Weg zu uns"), the shared quote-slider, a closing
