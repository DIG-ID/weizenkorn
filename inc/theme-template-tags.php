...
function weizenkorn_the_svg_icon( $name ) {
	...
	$icons = array(
		...
		// The filter trigger (Figma node 4129:5883, and Das Weizenkorn Team's own
		// identical one) — three horizontal sliders with a handle at a different point
		// on each line, traced from Figma's own vector as one filled path.
